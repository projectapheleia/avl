...
AVL uses `Z3 <https://microsoft.github.io/z3guide/programming/Z3%20Python/Introduction/>`_ to implement a full constraint \
solver.
...
This documents will not go into details of the `Z3 Solver <https://microsoft.github.io/z3guide/programming/Z3%20Python/Introduction/>`_ \
as they provide excellent documentation.

Constraints should be defined using `lambda functions <https://realpython.com/python-lambda/>`_. This means the function is evaluated when the randomize function is called \
...
This enables variable tracking and details the conflicting constraints. This feature should not be enabled by default. There is a performance overhead \
enabling the variable tracking, so it should only be used once an issue has been identified.
...
.. literalinclude:: ../../../examples/constraints/conflict/cocotb/example.py
    :language: python
